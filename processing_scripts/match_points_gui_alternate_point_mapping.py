# IMPORTANT: This is a TEST SCRIPT using the same mapping overlay for selecting and placing points. use match_points_gui for real data analysis
# 2026/5/11
